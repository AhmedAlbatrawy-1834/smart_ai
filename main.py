...
if __name__ == "__main__":
    ...
    img_path = r"img\101754.jpg"

    img = preprocessing.preprocess(img_path, device)
    ...
    model = load_model.train_model("models\plant_disease_classifier_state_dict.pth", class_names, device)

    p = prediction.predict(img, model, class_names)
    print(p)